...
puppi_files=[]
for idx in range(27):
   inputfile="/d0/scratch/shin/training_code/PUJetId_training_plotting/training/input/chs_2018_GenJetIdx_PFCands_input/training_trees_pt10To100_chs_PFCands_106X_%i_2018.root" %idx
...
#   p_nConstituents=ROOT.TH1D("nConstituents","nConstituents #eta #in %s" %eta_bin_range[x],40,0,40)
 ...
 #        Prompt_npvs=getattr(chs_sig_tree,"PV_npvsGood")
         Prompt_dR2Mean=getattr(chs_sig_tree,"Jet_PFCands_dR2Mean")
         Prompt_frac01=getattr(chs_sig_tree,"Jet_PFCands_frac01")
         Prompt_frac02=getattr(chs_sig_tree,"Jet_PFCands_frac02")
         Prompt_frac03=getattr(chs_sig_tree,"Jet_PFCands_frac03")
         Prompt_frac04=getattr(chs_sig_tree,"Jet_PFCands_frac04")
         Prompt_majW=getattr(chs_sig_tree,"Jet_PFCands_majW")
         Prompt_minW=getattr(chs_sig_tree,"Jet_PFCands_minW")
         Prompt_jetR=getattr(chs_sig_tree,"Jet_PFCands_jetR")
    #     Prompt_nConstituents=getattr(chs_sig_tree,"Jet_PFCands_nConstituents")
         Prompt_ptD=getattr(chs_sig_tree,"Jet_PFCands_ptD")
         Prompt_pull=getattr(chs_sig_tree,"Jet_PFCands_pull")
         Prompt_Rho=getattr(chs_sig_tree,"fixedGridRhoFastjetAll")
         if eta_bin!="Eta3p0To5p0":
            Prompt_Charged=getattr(chs_sig_tree,"Jet_PFCands_nCharged")
            Prompt_jetRchg=getattr(chs_sig_tree,"Jet_PFCands_jetRchg")
            Prompt_beta=getattr(chs_sig_tree,"Jet_PFCands_beta")
  ...
  #       c_npvs.Fill(Prompt_npvs)
   ...
   #      Pileup_npvs=getattr(chs_bkg_tree,"PV_npvsGood")
         Pileup_dR2Mean=getattr(chs_bkg_tree,"Jet_PFCands_dR2Mean")
         Pileup_frac01=getattr(chs_bkg_tree,"Jet_PFCands_frac01")
         Pileup_frac02=getattr(chs_bkg_tree,"Jet_PFCands_frac02")
         Pileup_frac03=getattr(chs_bkg_tree,"Jet_PFCands_frac03")
         Pileup_frac04=getattr(chs_bkg_tree,"Jet_PFCands_frac04")
         Pileup_majW=getattr(chs_bkg_tree,"Jet_PFCands_majW")
         Pileup_minW=getattr(chs_bkg_tree,"Jet_PFCands_minW")
         Pileup_jetR=getattr(chs_bkg_tree,"Jet_PFCands_jetR")
#         Pileup_nConstituents=getattr(chs_bkg_tree,"Jet_PFCands_nConstituents")
         Pileup_ptD=getattr(chs_bkg_tree,"Jet_PFCands_ptD")
         Pileup_pull=getattr(chs_bkg_tree,"Jet_PFCands_pull")
         Pileup_Rho=getattr(chs_bkg_tree,"fixedGridRhoFastjetAll")
         if eta_bin!="Eta3p0To5p0":
            Pileup_Charged=getattr(chs_bkg_tree,"Jet_PFCands_nCharged")
            Pileup_jetRchg=getattr(chs_bkg_tree,"Jet_PFCands_jetRchg")
            Pileup_beta=getattr(chs_bkg_tree,"Jet_PFCands_beta")
...
#         Prompt_npvs=getattr(puppi_sig_tree,"PV_npvsGood")
         Prompt_dR2Mean=getattr(puppi_sig_tree,"Jet_puId_dR2Mean")
         Prompt_frac01=getattr(puppi_sig_tree,"Jet_puId_frac01")
         Prompt_frac02=getattr(puppi_sig_tree,"Jet_puId_frac02")
         Prompt_frac03=getattr(puppi_sig_tree,"Jet_puId_frac03")
         Prompt_frac04=getattr(puppi_sig_tree,"Jet_puId_frac04")
         Prompt_majW=getattr(puppi_sig_tree,"Jet_puId_majW")
         Prompt_minW=getattr(puppi_sig_tree,"Jet_puId_minW")
         Prompt_jetR=getattr(puppi_sig_tree,"Jet_puId_jetR")
#         Prompt_nConstituents=getattr(puppi_sig_tree,"Jet_nConstituents")
         Prompt_ptD=getattr(puppi_sig_tree,"Jet_puId_ptD")
         Prompt_pull=getattr(puppi_sig_tree,"Jet_puId_pull")
         Prompt_Rho=getattr(puppi_sig_tree,"fixedGridRhoFastjetAll")
         if eta_bin!="Eta3p0To5p0":
            Prompt_Charged=getattr(puppi_sig_tree,"Jet_puId_nCharged")
            Prompt_jetRchg=getattr(puppi_sig_tree,"Jet_puId_jetRchg")
            Prompt_beta=getattr(puppi_sig_tree,"Jet_puId_beta")
...
#         Pileup_npvs=getattr(puppi_bkg_tree,"PV_npvsGood")
         Pileup_dR2Mean=getattr(puppi_bkg_tree,"Jet_puId_dR2Mean")
         Pileup_frac01=getattr(puppi_bkg_tree,"Jet_puId_frac01")
         Pileup_frac02=getattr(puppi_bkg_tree,"Jet_puId_frac02")
         Pileup_frac03=getattr(puppi_bkg_tree,"Jet_puId_frac03")
         Pileup_frac04=getattr(puppi_bkg_tree,"Jet_puId_frac04")
         Pileup_majW=getattr(puppi_bkg_tree,"Jet_puId_majW")
         Pileup_minW=getattr(puppi_bkg_tree,"Jet_puId_minW")
         Pileup_jetR=getattr(puppi_bkg_tree,"Jet_puId_jetR")
#         Pileup_nConstituents=getattr(puppi_bkg_tree,"Jet_nConstituents")
         Pileup_ptD=getattr(puppi_bkg_tree,"Jet_puId_ptD")
         Pileup_pull=getattr(puppi_bkg_tree,"Jet_puId_pull")
         Pileup_Rho=getattr(puppi_bkg_tree,"fixedGridRhoFastjetAll")
         if eta_bin!="Eta3p0To5p0":
            Pileup_Charged=getattr(puppi_bkg_tree,"Jet_puId_nCharged")
            Pileup_jetRchg=getattr(puppi_bkg_tree,"Jet_puId_jetRchg")
            Pileup_beta=getattr(puppi_bkg_tree,"Jet_puId_beta")
...
#         p_nConstituents.Fill(Pileup_nConstituents)
   ...
   for i,name in enumerate(var):
      ...
      if sig_max <= bkg_max:
         ...
         puppi_signal[i].Draw("HIST SAME")
      lgd.Draw("SAME")
      c.SaveAs("chs_PFCands_puId_plot_%s_%s_Prompt.png" %(name,eta_bin))
   ...
   for i,name in enumerate(var):
      ...
      if sig_max <= bkg_max:
         ...
         puppi_background[i].Draw("HIST SAME")
      lgd.Draw("SAME")
      c.SaveAs("chs_PFCands_puId_plot_%s_%s_Pileup.png" %(name,eta_bin))
   ...
   for i,name in enumerate(var):
      ...
      if sig_max <= bkg_max:
         ...
         puppi_combine[i].Draw("HIST SAME")
      lgd.Draw("SAME")
      c.SaveAs("chs_PFCands_puId_plot_%s_%s_Combined.png" %(name,eta_bin))
