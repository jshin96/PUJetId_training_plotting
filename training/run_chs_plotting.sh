...
chmod +x /u/user/shin/scratch/training_code/PUJetId_training_plotting/training/plot_input_variables_chs_puId_PFCands.py
/u/user/shin/scratch/training_code/PUJetId_training_plotting/training/plot_input_variables_chs_puId_PFCands.py --eta_s $eta_s --eta_f $eta_f
cd ..
