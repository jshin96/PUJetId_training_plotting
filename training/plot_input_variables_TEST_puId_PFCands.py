...
parser.add_argument(
   "--process", type=str, default="qcd", help="process name: tt qcd"
   )
parser.add_argument(
   "--dz", type=str, default="dZ0", help="dz variable name: dz dZ0"
   )
...
chs_files=[]
puppi_files=[]
inputfile="/d0/scratch/shin/training_code/PUJetId_training_plotting/training/input/training_trees_pt10To100_test_PFCand_106X_0_2018_%s_%s.root" %(process,dz_name)
chs_files.append(inputfile)
inputfile="/d0/scratch/shin/training_code/PUJetId_training_plotting/training/input/training_trees_pt10To100_test_PFCand_106X_0_2018_%s_%s.root" %(process, dz_name)
puppi_files.append(inputfile)
print("file added: training_trees_pt10To100_test_PFCand_106X_0_2018_%s_%s.root" %(process, dz_name))
...
#   p_nConstituents=ROOT.TH1D("nConstituents","nConstituents #eta #in %s" %eta_bin_range[x],40,0,40)
 ...
 #        Prompt_npvs=getattr(chs_sig_tree,"PV_npvsGood")
         Prompt_dR2Mean=getattr(chs_sig_tree,"JetCHS_PFCand_dR2Mean")
         Prompt_frac01=getattr(chs_sig_tree,"JetCHS_PFCand_frac01")
         Prompt_frac02=getattr(chs_sig_tree,"JetCHS_PFCand_frac02")
         Prompt_frac03=getattr(chs_sig_tree,"JetCHS_PFCand_frac03")
         Prompt_frac04=getattr(chs_sig_tree,"JetCHS_PFCand_frac04")
         Prompt_majW=getattr(chs_sig_tree,"JetCHS_PFCand_majW")
         Prompt_minW=getattr(chs_sig_tree,"JetCHS_PFCand_minW")
         Prompt_jetR=getattr(chs_sig_tree,"JetCHS_PFCand_jetR")
    #     Prompt_nConstituents=getattr(chs_sig_tree,"JetCHS_PFCand_nConstituents")
         Prompt_ptD=getattr(chs_sig_tree,"JetCHS_PFCand_ptD")
         Prompt_pull=getattr(chs_sig_tree,"JetCHS_PFCand_pull")
         if eta_bin!="Eta3p0To5p0":
            Prompt_Charged=getattr(chs_sig_tree,"JetCHS_PFCand_nCharged")
            Prompt_jetRchg=getattr(chs_sig_tree,"JetCHS_PFCand_jetRchg")
            Prompt_beta=getattr(chs_sig_tree,"JetCHS_PFCand_beta")
  ...
  #       c_npvs.Fill(Prompt_npvs)
   ...
   #      Pileup_npvs=getattr(chs_bkg_tree,"PV_npvsGood")
         Pileup_dR2Mean=getattr(chs_bkg_tree,"JetCHS_PFCand_dR2Mean")
         Pileup_frac01=getattr(chs_bkg_tree,"JetCHS_PFCand_frac01")
         Pileup_frac02=getattr(chs_bkg_tree,"JetCHS_PFCand_frac02")
         Pileup_frac03=getattr(chs_bkg_tree,"JetCHS_PFCand_frac03")
         Pileup_frac04=getattr(chs_bkg_tree,"JetCHS_PFCand_frac04")
         Pileup_majW=getattr(chs_bkg_tree,"JetCHS_PFCand_majW")
         Pileup_minW=getattr(chs_bkg_tree,"JetCHS_PFCand_minW")
         Pileup_jetR=getattr(chs_bkg_tree,"JetCHS_PFCand_jetR")
#         Pileup_nConstituents=getattr(chs_bkg_tree,"JetCHS_PFCand_nConstituents")
         Pileup_ptD=getattr(chs_bkg_tree,"JetCHS_PFCand_ptD")
         Pileup_pull=getattr(chs_bkg_tree,"JetCHS_PFCand_pull")
         if eta_bin!="Eta3p0To5p0":
            Pileup_Charged=getattr(chs_bkg_tree,"JetCHS_PFCand_nCharged")
            Pileup_jetRchg=getattr(chs_bkg_tree,"JetCHS_PFCand_jetRchg")
            Pileup_beta=getattr(chs_bkg_tree,"JetCHS_PFCand_beta")
...
#         Prompt_npvs=getattr(puppi_sig_tree,"PV_npvsGood")
         Prompt_dR2Mean=getattr(puppi_sig_tree,"JetCHS_puId_dR2Mean")
         Prompt_frac01=getattr(puppi_sig_tree,"JetCHS_puId_frac01")
         Prompt_frac02=getattr(puppi_sig_tree,"JetCHS_puId_frac02")
         Prompt_frac03=getattr(puppi_sig_tree,"JetCHS_puId_frac03")
         Prompt_frac04=getattr(puppi_sig_tree,"JetCHS_puId_frac04")
         Prompt_majW=getattr(puppi_sig_tree,"JetCHS_puId_majW")
         Prompt_minW=getattr(puppi_sig_tree,"JetCHS_puId_minW")
         Prompt_jetR=getattr(puppi_sig_tree,"JetCHS_puId_jetR")
#         Prompt_nConstituents=getattr(puppi_sig_tree,"JetCHS_nConstituents")
         Prompt_ptD=getattr(puppi_sig_tree,"JetCHS_puId_ptD")
         Prompt_pull=getattr(puppi_sig_tree,"JetCHS_puId_pull")
         if eta_bin!="Eta3p0To5p0":
            Prompt_Charged=getattr(puppi_sig_tree,"JetCHS_puId_nCharged")
            Prompt_jetRchg=getattr(puppi_sig_tree,"JetCHS_puId_jetRchg")
            Prompt_beta=getattr(puppi_sig_tree,"JetCHS_puId_beta")
...
#         Pileup_npvs=getattr(puppi_bkg_tree,"PV_npvsGood")
         Pileup_dR2Mean=getattr(puppi_bkg_tree,"JetCHS_puId_dR2Mean")
         Pileup_frac01=getattr(puppi_bkg_tree,"JetCHS_puId_frac01")
         Pileup_frac02=getattr(puppi_bkg_tree,"JetCHS_puId_frac02")
         Pileup_frac03=getattr(puppi_bkg_tree,"JetCHS_puId_frac03")
         Pileup_frac04=getattr(puppi_bkg_tree,"JetCHS_puId_frac04")
         Pileup_majW=getattr(puppi_bkg_tree,"JetCHS_puId_majW")
         Pileup_minW=getattr(puppi_bkg_tree,"JetCHS_puId_minW")
         Pileup_jetR=getattr(puppi_bkg_tree,"JetCHS_puId_jetR")
#         Pileup_nConstituents=getattr(puppi_bkg_tree,"JetCHS_nConstituents")
         Pileup_ptD=getattr(puppi_bkg_tree,"JetCHS_puId_ptD")
         Pileup_pull=getattr(puppi_bkg_tree,"JetCHS_puId_pull")
         if eta_bin!="Eta3p0To5p0":
            Pileup_Charged=getattr(puppi_bkg_tree,"JetCHS_puId_nCharged")
            Pileup_jetRchg=getattr(puppi_bkg_tree,"JetCHS_puId_jetRchg")
            Pileup_beta=getattr(puppi_bkg_tree,"JetCHS_puId_beta")
...
#         p_nConstituents.Fill(Pileup_nConstituents)
   ...
   if eta_bin!="Eta3p0To5p0":
      chs_signal=[cs_dR2Mean,cs_frac01,cs_frac02,cs_frac03,cs_frac04,cs_majW,cs_minW,cs_jetR,cs_ptD,cs_pull,cs_beta,cs_jetRchg,cs_Charged]
      chs_background=[cb_dR2Mean,cb_frac01,cb_frac02,cb_frac03,cb_frac04,cb_majW,cb_minW,cb_jetR,cb_ptD,cb_pull,cb_beta,cb_jetRchg,cb_Charged]
      chs_combine=[c_dR2Mean,c_frac01,c_frac02,c_frac03,c_frac04,c_majW,c_minW,c_jetR,c_ptD,c_pull,c_beta,c_jetRchg,c_Charged]
   if eta_bin=="Eta3p0To5p0":
      chs_signal=[cs_dR2Mean,cs_frac01,cs_frac02,cs_frac03,cs_frac04,cs_majW,cs_minW,cs_jetR,cs_ptD,cs_pull]
      chs_background=[cb_dR2Mean,cb_frac01,cb_frac02,cb_frac03,cb_frac04,cb_majW,cb_minW,cb_jetR,cb_ptD,cb_pull]
      chs_combine=[c_dR2Mean,c_frac01,c_frac02,c_frac03,c_frac04,c_majW,c_minW,c_jetR,c_ptD,c_pull]
   if eta_bin!="Eta3p0To5p0":
      puppi_signal=[ps_dR2Mean,ps_frac01,ps_frac02,ps_frac03,ps_frac04,ps_majW,ps_minW,ps_jetR,ps_ptD,ps_pull,ps_beta,ps_jetRchg,ps_Charged]
      puppi_background=[pb_dR2Mean,pb_frac01,pb_frac02,pb_frac03,pb_frac04,pb_majW,pb_minW,pb_jetR,pb_ptD,pb_pull,pb_beta,pb_jetRchg,pb_Charged]
      puppi_combine=[p_dR2Mean,p_frac01,p_frac02,p_frac03,p_frac04,p_majW,p_minW,p_jetR,p_ptD,p_pull,p_beta,p_jetRchg,p_Charged]
   if eta_bin=="Eta3p0To5p0":
      puppi_signal=[ps_dR2Mean,ps_frac01,ps_frac02,ps_frac03,ps_frac04,ps_majW,ps_minW,ps_jetR,ps_ptD,ps_pull]
      puppi_background=[pb_dR2Mean,pb_frac01,pb_frac02,pb_frac03,pb_frac04,pb_majW,pb_minW,pb_jetR,pb_ptD,pb_pull]
      puppi_combine=[p_dR2Mean,p_frac01,p_frac02,p_frac03,p_frac04,p_majW,p_minW,p_jetR,p_ptD,p_pull]
   
   if eta_bin!="Eta3p0To5p0":
      var=["dR2Mean","frac_01","frac_02","frac_03","frac_04","majW","minW","jetR","ptD","pull","beta","jetRchg","Charged"]
   if eta_bin=="Eta3p0To5p0":
      var=["dR2Mean","frac_01","frac_02","frac_03","frac_04","majW","minW","jetR","ptD","pull"]
   ...
   for i,name in enumerate(var):
      ...
      lgd.AddEntry(chs_signal[i],"PFCand")
      ...
      if sig_max <= bkg_max:
         ...
         puppi_signal[i].Draw("HIST SAME")
      lgd.Draw("SAME")
      c.SaveAs("TEST_PFCand_puId_plot_%s_%s_Prompt_%s_%s.png" %(name,eta_bin,process,dz_name))
   ...
   for i,name in enumerate(var):
      ...
      lgd.SetTextFont(42)
      lgd.SetTextSize(0.030)
      lgd.AddEntry(chs_background[i],"PFCand")
      ...
      if sig_max <= bkg_max:
         ...
         puppi_background[i].Draw("HIST SAME")
      lgd.Draw("SAME")
      c.SaveAs("TEST_PFCand_puId_plot_%s_%s_Pileup_%s_%s.png" %(name,eta_bin,process,dz_name))
   ...
   for i,name in enumerate(var):
      ...
      lgd.SetTextFont(42)
      lgd.SetTextSize(0.030)
      lgd.AddEntry(chs_combine[i],"PFCand")
      ...
      if sig_max <= bkg_max:
         ...
         puppi_combine[i].Draw("HIST SAME")
      lgd.Draw("SAME")
      c.SaveAs("TEST_PFCand_puId_plot_%s_%s_Combined_%s_%s.png" %(name,eta_bin,process,dz_name))
