...
#chmod +x make_training_trees_PUPPI_RUN3_test.py
#./make_training_trees_PUPPI_RUN3_test.py --era $1 --year $2 --jet_type $3 --inputFilesList $4 --minJet_pt $5 --maxJet_pt $6 --output_index $7
chmod +x make_training_trees_PUPPI_RUN3.py
./make_training_trees_PUPPI_RUN3.py --era $1 --year $2 --jet_type $3 --inputFilesList $4 --minJet_pt $5 --maxJet_pt $6 --output_index $7
