...
chmod +x make_training_trees_CHS_PFcands.py
./make_training_trees_CHS_PFcands.py --era $1 --year $2 --jet_type $3 --inputFilesList $4 --minJet_pt $5 --maxJet_pt $6 --output_index $7
