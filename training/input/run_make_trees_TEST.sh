...
chmod +x make_training_trees_TEST_PFCands.py
./make_training_trees_TEST_PFCands.py --era $1 --year $2 --jet_type $3 --inputFilesList $4 --minJet_pt $5 --maxJet_pt $6 --output_index $7 --process_name $8 --dz_name $9
