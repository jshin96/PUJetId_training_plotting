...
chmod +x /u/user/shin/scratch/training_code/PUJetId_training_plotting/training/plot_input_variables_puppi_RUN3.py
/u/user/shin/scratch/training_code/PUJetId_training_plotting/training/plot_input_variables_puppi_RUN3.py #--eta_s $eta_s #--eta_f $eta_f
cd ..
